...
# test 1
./out/build/x64-Debug/ARTracking.exe ./videos/new_video/cut/combination-cut.mp4 ./calibration.txt "IMPROVED" ./image.png 20 > results_improved_new_videos/combination-cut.txt
./out/build/x64-Debug/ARTracking.exe ./videos/new_video/cut/scale-cut.mp4 ./calibration.txt "IMPROVED" ./image.png 20 > results_improved_new_videos/scale-cut.txt
./out/build/x64-Debug/ARTracking.exe ./videos/new_video/cut/occlusion-cut.mp4 ./calibration.txt "IMPROVED" ./image.png 20 > results_improved_new_videos/occlusion-cut.txt
./out/build/x64-Debug/ARTracking.exe ./videos/new_video/cut/plane_rotation-cut.mp4 ./calibration.txt "IMPROVED" ./image.png 20 > results_improved_new_videos/plane_rotation-cut.txt
./out/build/x64-Debug/ARTracking.exe ./videos/new_video/cut/out_plane_rotation-cut.mp4 ./calibration.txt "IMPROVED" ./image.png 20 > results_improved_new_videos/out_plane_rotation-cut.txt
